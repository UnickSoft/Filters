...
QT_MOC_LITERAL(3, 29, 7), // "index_t"
QT_MOC_LITERAL(4, 37, 5), // "index"
QT_MOC_LITERAL(5, 43, 9), // "Parameter"
QT_MOC_LITERAL(6, 53, 5) // "value"

    },
    "FilterControls\0paramChanged\0\0index_t\0"
    "index\0Parameter\0value"
};
...
void FilterControls::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->paramChanged((*reinterpret_cast< index_t(*)>(_a[1])),(*reinterpret_cast< const Parameter(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (FilterControls::*_t)(index_t , const Parameter & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FilterControls::paramChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject FilterControls::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_FilterControls.data,
      qt_meta_data_FilterControls,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FilterControls::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FilterControls.stringdata0))
        return static_cast<void*>(const_cast< FilterControls*>(this));
...
// SIGNAL 0
void FilterControls::paramChanged(index_t _t1, const Parameter & _t2)
{
