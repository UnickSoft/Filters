...
class AlphaBlend : public IFilter
{
public:

    AlphaBlend (const IPrivateFilterList& filterList, IResourceManager& resourceManager);
    ...
    void setInputsNumber(index_t number);
    
private:

    IResourceManager& resourceManager;
    const IPrivateFilterList& filterList;
    index_t inputsNumber_;
